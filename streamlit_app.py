...
with st.form(key='input_form'):
 ...
 　 st.write("日本語と英語の区別をつけるためにかっこをつけてください。")
    input_prompt = '''あなたは英語学習アシスタントです。ユーザは高校生で、あなたに英語の質問を投げかけます。あなたは高校の英語教師のかわりに高校の教員として、英語の日本語訳や文法、論理構造に関する回答をわかりやすく、長文で、可能な限り根拠や実験方法や斬新なアイデアをステップバイステップで示した上で以下の######内の質問に返してください。'''
